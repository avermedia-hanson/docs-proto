...
-   :material-video: Some Video SDK
    ...
    [:octicons-arrow-right-24: Explore the SDK](some-video-sdk/index.html)

-   :material-face-agent: Some AI SDK

    ---

    Pure Python project, work in progress
